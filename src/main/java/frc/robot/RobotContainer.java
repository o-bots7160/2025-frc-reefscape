...
private final Joystick joystickOperatorInterface = new Joystick(0);
  ...
  private RobotContainer() {
    ...
    m_driveBaseSubsystem.setDefaultCommand(new DriveManualMoveCommand(() -> joystickOperatorInterface.getRawAxis(1), () -> joystickOperatorInterface.getRawAxis(0), () -> joystickOperatorInterface.getRawAxis(4), m_driveBaseSubsystem));
