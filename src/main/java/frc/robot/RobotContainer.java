...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    m_driveBaseSubsystem.setDefaultCommand( m_driveBaseSubsystem.moveManual(() -> m_driverController.getRawAxis(1), () -> m_driverController.getRawAxis(0), () -> m_driverController.getRawAxis(4)));
