...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    m_driveBaseSubsystem.setDefaultCommand(new DriveManualMoveCommand(() -> m_driverController.getRawAxis(1), () -> m_driverController.getRawAxis(0), () -> m_driverController.getRawAxis(4), m_driveBaseSubsystem));
  ...
  private void configureButtonBindings() {
    ...
    new Trigger( m_driverController.button( 2 ) ).whileTrue( new DriveAngleSetCommand(new Rotation2d( 0.0 ), m_driveBaseSubsystem));
  }
