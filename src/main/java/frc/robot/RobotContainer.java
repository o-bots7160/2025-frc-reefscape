...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    m_driveBaseSubsystem.setDefaultCommand(new ManualMoveCommand(() -> joystickOperatorInterface.getRawAxis(0),
        () -> joystickOperatorInterface.getRawAxis(1), () -> joystickOperatorInterface.getRawAxis(2),
