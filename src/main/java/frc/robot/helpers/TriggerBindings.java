...
public class TriggerBindings {
    ...
    private void assignGameControllerBindings() {
        ...
        gameController.onButtonHold(GameController.GameControllerButton.X, cf.createElevatorSysIdCommand(2, 2, 2));
        gameController.onButtonHold(GameController.GameControllerButton.Y, cf.createMoveElevatorCommand(() -> 25.0));
