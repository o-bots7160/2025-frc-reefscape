...
public class ElevatorSubsystem extends ObotSubsystemBase {
    ...
    public  BooleanSupplier clearToStow        = ()->{ return true; };
    ...
    */
    public ElevatorSubsystem( ) {
        ...
        config.encoder.positionConversionFactor(metersPerPulse)
                .velocityConversionFactor(metersPerPulse);
    ...
    */
    ...
    {
       return new SysIdRoutine( config, new SysIdRoutine.Mechanism( ( volts )->this.setVoltage( volts.baseUnitMagnitude( ) ),
